# Drone4Dengue Test Scripts

This repository contains automated test scripts for the **Drone4Dengue** system using:
...
```bash
pip install pytest selenium appium-python-client webdriver-manager
```
